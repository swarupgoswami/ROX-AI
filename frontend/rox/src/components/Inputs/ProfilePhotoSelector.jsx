    ...
    <div className='flex justify-center mb-6'>
      ...
      {!image ? (
        ...
        <div className="relative">
          <img src={preview || previewUrl} alt="profile pic" className='w-20 h-20 rounded-full object-cover' />
          <button
            type='button'
            className='w-8 h-8 flex items-center justify-center rounded-full absolute -bottom-1 -right-1 cursor-pointer'
